...
class MyDataset(Dataset):
    ...
    def __init__(self, dataset:str):
        ...
        user_sequences, user_degree, item_sequences, item_rating, item_degree = self.load_data()
    ...
    def __getitem__(self, idx):
        ...
        for index in item_indexer:
            ...
            degree_list.append(self.item_degree[index])
        ...
        item_degree = torch.stack(degree_list, 0)

        # TODO: Used dictionary to perform PyG-like data accessing.
        # return user_seq, user_deg, item_seq, item_rating
        return {'user_seq': user_seq, 'user_degree': user_deg, 'item_seq': item_seq, 'rating': item_rating, 'item_degree': item_degree}
    ...
    def load_data(self):
        ...
        item_degree = item_df['product_degree'].to_numpy(dtype=object)
        item_degree = np.array([np.array(x) for x in item_degree])

        return user_sequences, user_degree, item_sequences, item_rating, item_degree
